...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    .antMatchers(HttpMethod.POST, "/api/users/{id}/resume**").hasAnyAuthority("VOLUNTEER","ADMIN","ORGANIZATION")
    .antMatchers(HttpMethod.POST, "/api/assets/**").hasAnyAuthority("VOLUNTEER","ADMIN")
