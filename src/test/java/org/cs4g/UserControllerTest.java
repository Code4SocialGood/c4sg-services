...
public class UserControllerTest {
	...
	public void testGetUsers() throws Exception {
		...
		this.mockMvc.perform(get("/api/users").accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
				...
				.andExpect(jsonPath("$[0].github", is(1))).andExpect(jsonPath("$[0].userName", is("test1UserName")))
				...
				.andExpect(jsonPath("$[0].phone", is("9542234567"))).andExpect(jsonPath("$[0].status", is("A")))
				.andExpect(jsonPath("$[0].role", is("V"))).andExpect(jsonPath("$[0].state", is("CA")))
				.andExpect(jsonPath("$[0].country", is("USA"))).andExpect(jsonPath("$[1].id", is(2)))
				.andExpect(jsonPath("$[1].github", is(2))).andExpect(jsonPath("$[1].userName", is("test2UserName")))
				...
				.andExpect(jsonPath("$[1].phone", is("9542234567"))).andExpect(jsonPath("$[1].status", is("P")))
				.andExpect(jsonPath("$[1].role", is("V"))).andExpect(jsonPath("$[1].state", is("CA")))
				.andExpect(jsonPath("$[1].country", is("USA"))).andExpect(jsonPath("$[2].id", is(3)))
				.andExpect(jsonPath("$[2].github", is(3))).andExpect(jsonPath("$[2].userName", is("dev3UserName")))
				...
				.andExpect(jsonPath("$[2].phone", is("9542234567"))).andExpect(jsonPath("$[2].status", is("A")))
				.andExpect(jsonPath("$[2].role", is("D"))).andExpect(jsonPath("$[2].state", is("CA")))
				.andExpect(jsonPath("$[2].country", is("USA"))).andExpect(jsonPath("$[3].id", is(4)))
				.andExpect(jsonPath("$[3].github", is(4))).andExpect(jsonPath("$[3].userName", is("vol4UserName")))
				...
				.andExpect(jsonPath("$[3].phone", is("9542234567"))).andExpect(jsonPath("$[3].status", is("D")))
				.andExpect(jsonPath("$[3].role", is("V"))).andExpect(jsonPath("$[3].state", is("CA")))
	...
	public void testGetActiveUsers() throws Exception {
		...
		this.mockMvc
				.perform(get("/api/users/active").accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
				.andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
				...
				.andExpect(jsonPath("$[0].phone", is("9542234567"))).andExpect(jsonPath("$[0].status", is("A")))
				.andExpect(jsonPath("$[0].role", is("V"))).andExpect(jsonPath("$[0].state", is("CA")))
				.andExpect(jsonPath("$[0].country", is("USA"))).andExpect(jsonPath("$[1].id", is(3)))
				.andExpect(jsonPath("$[1].github", is(3))).andExpect(jsonPath("$[1].userName", is("dev3UserName")))
				...
				.andExpect(jsonPath("$[1].phone", is("9542234567"))).andExpect(jsonPath("$[1].status", is("A")))
				.andExpect(jsonPath("$[1].role", is("D"))).andExpect(jsonPath("$[1].state", is("CA")))
	...
	public void testGetUserById() throws Exception {
		...
		this.mockMvc
				.perform(get("/api/users/{id}", 1).accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
				.andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(jsonPath("$.id", is(1))).andExpect(jsonPath("$.github", is(1)))
				...
				.andExpect(jsonPath("$.phone", is("9542234567"))).andExpect(jsonPath("$.status", is("A")))
				.andExpect(jsonPath("$.role", is("V"))).andExpect(jsonPath("$.state", is("CA")))
	...
	public void testGetUserByIdNotFound() throws Exception {
		...
		when(userServiceMock.findById(10)).thenReturn(null);

		this.mockMvc
				.perform(get("/api/users/{id}", 10).accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
				.andExpect(status().isNotFound());

		verify(userServiceMock, times(1)).findById(10);
		verifyNoMoreInteractions(userServiceMock);
	...
	public void testGetDevelopers() throws Exception {
		// code is commented because findDevelopers() method in UserService
		// returns User instead of UserDTO
	...
	public void testSearchByUserName() throws Exception {
		List<UserDTO> exactMatchSearchUsers = getMockUsers("ExactMatchSearch");
		List<UserDTO> multipleMatchSearchUsers = getMockUsers("MultipleMatchSearch");

		// Exact match
		when(userServiceMock.search("test1UserName", "", "")).thenReturn(exactMatchSearchUsers);
		// multiple matches
		when(userServiceMock.search("UserName", "", "")).thenReturn(multipleMatchSearchUsers);

		this.mockMvc
				.perform(get("/api/users/search").param("userName", "test1UserName").param("firstName", "")
						.param("lastName", ""))
				.andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
		...
		this.mockMvc
				.perform(get("/api/users/search").param("userName", "UserName").param("firstName", "").param("lastName",
						""))
				.andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(jsonPath("$", hasSize(2))).andExpect(jsonPath("$[0].id", is(1)))
				.andExpect(jsonPath("$[0].github", is(1))).andExpect(jsonPath("$[0].userName", is("test1UserName")))
		...
		verify(userServiceMock, times(1)).search("test1UserName", "", "");
		verify(userServiceMock, times(1)).search("UserName", "", "");
		verifyNoMoreInteractions(userServiceMock);
	...
	public void testSearchByFirstName() throws Exception {
		...
		when(userServiceMock.search("", "test1FirstName", "")).thenReturn(exactMatchSearchUsers);
		when(userServiceMock.search("", "FirstName", "")).thenReturn(multipleMatchSearchUsers);

		this.mockMvc
				.perform(get("/api/users/search").param("userName", "").param("firstName", "test1FirstName")
						.param("lastName", ""))
				.andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(jsonPath("$", hasSize(1))).andExpect(jsonPath("$[0].id", is(1)))
				.andExpect(jsonPath("$[0].github", is(1))).andExpect(jsonPath("$[0].userName", is("test1UserName")))
		...
		this.mockMvc
				.perform(get("/api/users/search").param("userName", "").param("firstName", "FirstName")
						.param("lastName", ""))
				.andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(jsonPath("$", hasSize(2))).andExpect(jsonPath("$[0].id", is(1)))
				.andExpect(jsonPath("$[0].github", is(1))).andExpect(jsonPath("$[0].userName", is("test1UserName")))
		...
		verify(userServiceMock, times(1)).search("", "test1FirstName", "");
		verify(userServiceMock, times(1)).search("", "FirstName", "");
		verifyNoMoreInteractions(userServiceMock);
	...
	public void testSearchByLastName() throws Exception {
		...
		when(userServiceMock.search("", "", "test1LastName")).thenReturn(exactMatchSearchUsers);
		when(userServiceMock.search("", "", "LastName")).thenReturn(multipleMatchSearchUsers);

		this.mockMvc
				.perform(get("/api/users/search").param("userName", "").param("firstName", "").param("lastName",
						"test1LastName"))
				.andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(jsonPath("$", hasSize(1))).andExpect(jsonPath("$[0].id", is(1)))
				.andExpect(jsonPath("$[0].github", is(1))).andExpect(jsonPath("$[0].userName", is("test1UserName")))
		...
		verify(userServiceMock, times(1)).search("", "", "test1LastName");
		verify(userServiceMock, times(1)).search("", "", "LastName");
		verifyNoMoreInteractions(userServiceMock);

	}

	@Test
	public void testSearchByAllParameters() throws Exception {
		List<UserDTO> exactMatchSearchUsers = getMockUsers("ExactMatchSearch");

		// multiple conditions
		when(userServiceMock.search("test1", "FirstName", "Name")).thenReturn(exactMatchSearchUsers);

		this.mockMvc
				.perform(get("/api/users/search").param("userName", "test1").param("firstName", "FirstName")
						.param("lastName", "Name"))
				.andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(jsonPath("$", hasSize(1))).andExpect(jsonPath("$[0].id", is(1)))
				.andExpect(jsonPath("$[0].github", is(1))).andExpect(jsonPath("$[0].userName", is("test1UserName")))
		...
		verify(userServiceMock, times(1)).search("test1", "FirstName", "Name");
		verifyNoMoreInteractions(userServiceMock);

	}

	@Test
	public void testSearchWithEmptyParameters() throws Exception {

		// Mock user data
		List<UserDTO> allUsers = getMockUsers("All");

		// multiple conditions
		when(userServiceMock.search("", "", "")).thenReturn(allUsers);
		...
		verify(userServiceMock, times(1)).search("", "", "");
		verifyNoMoreInteractions(userServiceMock);
	...
	public void testSearchWithNoResult() throws Exception {
		...
		// multiple conditions
		when(userServiceMock.search("testuser", "testuser", "testuser")).thenReturn(null);

		this.mockMvc
				.perform(get("/api/users/search").param("userName", "testuser").param("firstName", "testuser").param("lastName", "testuser"))
				.andExpect(status().isNotFound());

		verify(userServiceMock, times(1)).search("testuser", "testuser", "testuser");
		verifyNoMoreInteractions(userServiceMock);
	...
	public void testCreateUser() throws Exception {
		...
		this.mockMvc.perform(post("/api/users").contentType(MediaType.APPLICATION_JSON).content(asJsonString(user)))
	...
	public void testUpdateUser() throws Exception {
		...
		this.mockMvc.perform(put("/api/users").contentType(MediaType.APPLICATION_JSON).content(asJsonString(user)))
				.andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(jsonPath("$.id", is(1))).andExpect(jsonPath("$.github", is(1)))
				.andExpect(jsonPath("$.userName", is("test1UserName")))
				.andExpect(jsonPath("$.firstName", is("test1FirstName")))
	...
	public void testUploadAvatar() throws Exception {
		// Mocking user id and image upload path
		int userId = 2;
		String uploadPath = AVATAR_UPLOAD.getValue() + File.separator + userId + IMAGE.getValue();
	...
	@Test
	public void testUploadAvatarFail() throws Exception {
		// Mocking user id and image upload path
		int userId = 2;
		String uploadPath = AVATAR_UPLOAD.getValue() + File.separator + userId + IMAGE.getValue();
	...
	public void testUploadResume() throws Exception {
		// Mocking user id and image upload path
		int userId = 2;
		String uploadPath = RESUME_UPLOAD.getValue() + File.separator + userId + RESUME.getValue();
	...
	@Test
	public void testUploadResumeFail() throws Exception {
		// Mocking user id and image upload path
		int userId = 2;
		String uploadPath = RESUME_UPLOAD.getValue() + File.separator + userId + RESUME.getValue();
	...
	List<UserDTO> getMockUsers(String condition) {
		...
		if (condition == "Active") {
			...
			return Arrays.asList(userDto);
		} else if (condition == "ExactMatchSearch") {
			return Arrays.asList(userDto);
		} else if (condition == "MultipleMatchSearch") {
