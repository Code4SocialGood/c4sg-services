...
public class TestDataSet {
    ...
    static final String PROJECT_1_NAME = "WebSite Construction";
    ...
    static final String PROJECT_1_CREATED_TIME = "2017-01-01 00:00:00";
    static final String PROJECT_2_NAME = "PROTOTYPING A MOBILE SITE";
